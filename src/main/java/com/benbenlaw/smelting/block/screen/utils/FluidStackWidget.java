package com.benbenlaw.smelting.block.screen.utils;
...
public class FluidStackWidget extends OpolisUtilitiesWidget {
    ...
    public void renderToolTip(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        if (MouseUtil.isMouseAboveArea(mouseX, mouseY, this.x, this.y, 0, 0, 14, 26)) {
            ...
            FormattedCharSequence[] var10002 = new FormattedCharSequence[]{this.getFluid.getFluid().getHoverName().getVisualOrderText(), null};
            int var10005 = this.getFluid.getFluidAmount();
            var10002[1] = Component.literal("" + var10005 + "mB / " + this.getFluid.getCapacity() + "mb").getVisualOrderText();
            guiGraphics.renderTooltip(var10001, Arrays.asList(var10002), mouseX, mouseY);
        }
    }
}