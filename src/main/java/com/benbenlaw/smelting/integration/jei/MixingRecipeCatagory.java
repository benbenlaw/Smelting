...
public class MixingRecipeCatagory implements IRecipeCategory<MixingRecipe> {
    public final static ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(Smelting.MOD_ID, "mixing");
    public final static ResourceLocation TEXTURE =
            ResourceLocation.fromNamespaceAndPath(Smelting.MOD_ID, "textures/gui/jei_mixer.png");

    public static final RecipeType<MixingRecipe> RECIPE_TYPE = RecipeType.create(Smelting.MOD_ID, "mixing",
            MixingRecipe.class);
