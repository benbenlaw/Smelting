...
public class CastingRecipes extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.IRON_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(Items.IRON_INGOT), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(Items.IRON_NUGGET), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(ironGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(ironRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_IRON.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(ironPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_IRON.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.GOLD_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1),new SizedIngredient(Ingredient.of(Items.GOLD_INGOT), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(Items.GOLD_NUGGET), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(goldGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(goldRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_GOLD.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(goldPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_GOLD.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1),new SizedIngredient(Ingredient.of(Items.COPPER_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(Items.COPPER_INGOT), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(com.benbenlaw.opolisutilities.item.ModItems.COPPER_NUGGET), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(copperGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(copperRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_COPPER.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(copperPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_COPPER.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(tinBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(tinIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(ModdedTags.tinNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(tinGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(tinRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_TIN.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(tinPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_TIN.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(osmiumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(osmiumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(osmiumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(osmiumGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(osmiumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_OSMIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(osmiumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_OSMIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(uraniumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(uraniumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(uraniumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(uraniumGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(uraniumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_URANIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(uraniumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_URANIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(leadBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(leadIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(leadNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(leadGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(leadRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_LEAD.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(leadPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_LEAD.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(silverBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(silverIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(silverNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(silverGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(silverRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_SILVER.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(silverPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_SILVER.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.COAL_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.EMERALD_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEM_MOLD, 1), new SizedIngredient(Ingredient.of(Items.EMERALD), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(emeraldGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(Items.EMERALD), 1),
                        new FluidStack(CastingFluids.MOLTEN_EMERALD.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.DIAMOND_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEM_MOLD, 1), new SizedIngredient(Ingredient.of(Items.DIAMOND), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(diamondGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.REDSTONE_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.DUST_MOLD, 1), new SizedIngredient(Ingredient.of(Items.REDSTONE), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1),new SizedIngredient(Ingredient.of(Items.LAPIS_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEM_MOLD, 1), new SizedIngredient(Ingredient.of(Items.LAPIS_LAZULI), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(lapisGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.OBSIDIAN), 1),
                        new FluidStack(CastingFluids.MOLTEN_OBSIDIAN.getFluid(), 1000))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(bronzeBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(bronzeIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(bronzeNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(bronzeGearTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_BRONZE.getFluid(), 360))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(bronzeRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_BRONZE.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(bronzePlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_BRONZE.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(steelBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(steelIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(steelNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(steelGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(steelRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(steelPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Blocks.NETHERITE_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(Tags.Items.INGOTS_NETHERITE), 1),
                        new FluidStack(CastingFluids.MOLTEN_NETHERITE.getFluid(), 90))
                    .unlockedBy("has_item", has(Tags.Items.INGOTS_NETHERITE)).save(consumer, "casting:solidifier/netherite/ingot");

        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(netheriteNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(netheriteGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(netheriteRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_NETHERITE.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(netheritePlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_NETHERITE.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.QUARTZ_BLOCK), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEM_MOLD, 1), new SizedIngredient(Ingredient.of(Items.QUARTZ), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.GLASS), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.STONE), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(stonePlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_STONE.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(electrumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(electrumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(electrumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(electrumGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(electrumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ELECTRUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(electrumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ELECTRUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(invarBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(invarIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(invarNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(invarGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(invarRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_INVAR.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(invarPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_INVAR.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(nickelBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(nickelIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_NICKEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(nickelNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(nickelGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(nickelRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_NICKEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(nickelPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_NICKEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(zincBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(zincIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(zincNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(zincGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(zincRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ZINC.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(zincPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ZINC.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(iridiumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(iridiumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(iridiumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(iridiumGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(iridiumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_IRIDIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(iridiumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_IRIDIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(platinumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(platinumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(platinumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(platinumGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(platinumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_PLATINUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(platinumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_PLATINUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(aluminumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(aluminumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(aluminumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(aluminumGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(aluminumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ALUMINUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(aluminumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ALUMINUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(signalumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(signalumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(signalumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(signalumGearTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_SIGNALUM.getFluid(), 360))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(signalumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_SIGNALUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(signalumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_SIGNALUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(lumiumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(lumiumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(lumiumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(lumiumGearTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_LUMIUM.getFluid(), 360))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(lumiumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_LUMIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(lumiumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_LUMIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(enderiumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(enderiumIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(enderiumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(enderiumGearTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ENDERIUM.getFluid(), 360))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(enderiumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ENDERIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(enderiumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ENDERIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(constantanBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(constantanIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(constantanNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(constantanGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(constantanRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_CONSTANTAN.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(constantanPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_CONSTANTAN.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(brassBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(brassIngotTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(brassNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(brassGearTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_BRASS.getFluid(), 360))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(brassRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_BRASS.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(brassPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_BRASS.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(Items.ENDER_PEARL), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.DUST_MOLD, 1), new SizedIngredient(Ingredient.of(Items.GLOWSTONE_DUST), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.GLOWSTONE), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.DUST_MOLD, 1), new SizedIngredient(Ingredient.of(siliconDust), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(silicon), 1),
                        new FluidStack(CastingFluids.MOLTEN_SILICON.getFluid(), 250))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(ItemTags.SOUL_FIRE_BASE_BLOCKS), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(Items.END_STONE), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(conductiveAlloyBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(conductiveAlloyIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_CONDUCTIVE_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(conductiveAlloyNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(conductiveAlloyGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(conductiveAlloyRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_CONDUCTIVE_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(conductiveAlloyPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_CONDUCTIVE_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:conductive_alloy_grinding_ball")).getDefaultInstance()), 24),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(energeticAlloyBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(energeticAlloyIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ENERGETIC_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(energeticAlloyNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(energeticAlloyGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(energeticAlloyRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ENERGETIC_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(energeticAlloyPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_ENERGETIC_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:energetic_alloy_grinding_ball")).getDefaultInstance()), 24),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(vibrantAlloyBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(vibrantAlloyIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_VIBRANT_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(vibrantAlloyNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(vibrantAlloyGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(vibrantAlloyRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_VIBRANT_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(vibrantAlloyPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_VIBRANT_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:vibrant_alloy_grinding_ball")).getDefaultInstance()), 24),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(pulsatingAlloyBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(pulsatingAlloyIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_PULSATING_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(pulsatingAlloyNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(pulsatingAlloyGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(pulsatingAlloyRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_PULSATING_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(pulsatingAlloyPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_PULSATING_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:pulsating_alloy_grinding_ball")).getDefaultInstance()), 24),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(soulariumBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(soulariumIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_SOULARIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(soulariumNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(soulariumGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(soulariumRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_SOULARIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(soulariumPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_SOULARIUM.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:soularium_grinding_ball")).getDefaultInstance()), 24),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(darkSteelBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(darkSteelIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_DARK_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(darkSteelNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(darkSteelGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(darkSteelRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_DARK_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(darkSteelPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_DARK_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:dark_steel_grinding_ball")).getDefaultInstance()), 24),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(endSteelBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(endSteelIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_END_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(endSteelNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(endSteelGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(endSteelRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_END_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(endSteelPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_END_STEEL.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:end_steel_grinding_ball")).getDefaultInstance()), 24),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(redstoneAlloyBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(redstoneAlloyIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_REDSTONE_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(redstoneAlloyNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(redstoneAlloyGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(redstoneAlloyRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_REDSTONE_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(redstoneAlloyPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_REDSTONE_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:redstone_alloy_grinding_ball")).getDefaultInstance()), 24),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BLOCK_MOLD, 1), new SizedIngredient(Ingredient.of(copperAlloyBlockTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.INGOT_MOLD, 1), new SizedIngredient(Ingredient.of(copperAlloyIngotTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_COPPER_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.NUGGET_MOLD, 1), new SizedIngredient(Ingredient.of(copperAlloyNuggetTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.GEAR_MOLD, 1), new SizedIngredient(Ingredient.of(copperAlloyGearTag), 1),
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.ROD_MOLD, 1), new SizedIngredient(Ingredient.of(copperAlloyRodTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_COPPER_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.PLATE_MOLD, 1), new SizedIngredient(Ingredient.of(copperAlloyPlateTag), 1),
                        new FluidStack(CastingFluids.MOLTEN_COPPER_ALLOY.getFluid(), 90))
        ...
        SolidifierRecipeBuilder.SolidifierRecipesBuilder(SizedIngredient.of(ModItems.BALL_MOLD, 1), new SizedIngredient(Ingredient.of(BuiltInRegistries.ITEM.get(ResourceLocation.parse("enderio:copper_alloy_grinding_ball")).getDefaultInstance()), 24),
